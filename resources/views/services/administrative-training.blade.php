      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
            ...
            <h3>توفير لبرامج التدريب الاداري</h3>
            <p>
                تقدم شركتنا مجموعة متكاملة من خدمات التدريب الإداري التي تهدف إلى تطوير مهارات القيادة والإدارة لدى الأفراد، مما يعزز من كفاءتهم في بيئات العمل المختلفة. تشمل خدماتنا ما يلي:
            </p>
            <ul>
            ...
            <p>
                بهذا الشكل، تضمن خدمات التدريب الإداري تقديم تجربة تعليمية شاملة تدعم الأفراد والمنظمات في تحقيق نجاحاتهم الإدارية.
            </p>
          </div>
          ...
          <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
            <div class="services-list">
                ...
                <a href="{{ route('administrative_training') }}" class="active">برامج التدريب الاداري</a>
